class AppConfiguration < Configuration
  ...
  preference :site_url, :string, :default => 'psa.octagonoecommerce.com.br'
  ...
  preference :default_locale, :string, :default => 'pt-BR'
  preference :allow_locale_switching, :boolean, :default => true
  preference :default_country_id, :integer, :default => 28
